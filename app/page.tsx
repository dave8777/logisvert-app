...
const GREE_MODELS: ModelRow[] = [
  ...
  // FLEEX
  { series: "FLEEX", type: "Central", size: "24k", outdoor: "GREGUD36W2NHEDU", indoor: "GREGUD24AH2EDU", ahri: "216621482", rebate: 2472 },
  { series: "FLEEX", type: "Central", size: "36k", outdoor: "GREGUD36W2NHEDU", indoor: "GREGUD36AH2EDU", ahri: "214568826", rebate: 3384 },
  { series: "FLEEX", type: "Central", size: "36k GDU", outdoor: "GREGUD36W2NHEDU", indoor: "GREGUD36AH2GDU", ahri: "217120760", rebate: 3384 },
  { series: "FLEEX", type: "Central", size: "48k", outdoor: "GREGUD60W2NHEDU", indoor: "GREGUD48AH2EDU", ahri: "216621484", rebate: 4740 },
  { series: "FLEEX", type: "Central", size: "60k", outdoor: "GREGUD60W2NHEDU", indoor: "GREGUD60AH2GDU", ahri: "214568857", rebate: 5400 },

  { series: "FLEEX Add-on", type: "Central Add-on", size: "24k", outdoor: "GREGUD36W2NHEDU", indoor: "GREGCAC24FNHA", ahri: "216768109", rebate: 1800 },
  { series: "FLEEX Add-on", type: "Central Add-on", size: "36k", outdoor: "GREGUD36W2NHEDU", indoor: "GREGCAC36FNHA", ahri: "216765692", rebate: 2640 },
  { series: "FLEEX Add-on", type: "Central Add-on", size: "48k", outdoor: "GREGUD60W2NHEDU", indoor: "GREGCAC48HNHA", ahri: "216768110", rebate: 4224 },
  { series: "FLEEX Add-on", type: "Central Add-on", size: "60k", outdoor: "GREGUD60W2NHEDU", indoor: "GREGCAC60HNHA", ahri: "216765694", rebate: 4800 },
]
...
export default function Home() {
  ...
  const typeOptions = useMemo(
    () =>
      [...new Set(GREE_MODELS.filter((m) => !series || m.series === series).map((m) => m.type))],
    [series]
  )
  ...
  return (
    <div style={{ padding: 20, maxWidth: 700, margin: "0 auto", fontFamily: "Arial, sans-serif" }}>
      ...
      {selected && (
        <div style={{ marginTop: 28, padding: 20, border: "1px solid #ccc", borderRadius: 12 }}>
          <h2 style={{ marginTop: 0 }}>{selected.series} — {selected.type} — {selected.size}</h2>
          <p><strong>AHRI:</strong> {selected.ahri || "n/a"}</p>
          <p><strong>Subvention:</strong> {formatMoney(selected.rebate)}</p>
